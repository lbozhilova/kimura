...
The goal of `kimura` is to fit Kimura dsitributions to heteroplasmy data and 
...
There is also some additional functionality for generating data from the Kimura distirbution.
